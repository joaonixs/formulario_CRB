...
function validateForm(){
    var x = document.forms["CRBform"]["nome"].value;
    if (x == ""){
      alert("O campo Nome precisa estar preenchido!");
      return false;
    }
    var x = document.forms["CRBform"]["email"].value;
    if (x == ""){
      alert("O campo E-mail precisa estar preenchido!");
      return false;
    }
      var x = document.forms["CRBform"]["telefone"].value;
    if (x == ""){
      alert("O campo Telefone precisa estar preenchido!");
      return false;
    }
    var x = document.forms["CRBform"]["state"].value;
    if (x == ""){
      alert("O campo Estado precisa estar preenchido!");
      return false;
    }
    var x = document.forms["CRBform"]["city"].value;
    if (x == ""){
      alert("O campo Cidade precisa estar preenchido!");
      return false;
    }
}
